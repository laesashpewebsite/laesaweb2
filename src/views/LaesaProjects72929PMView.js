...
class LaesaProjects72929PMView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/LaesaProjects72929PMController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = LaesaProjects72929PMView
  ...
  render() {
    const proxies = Controller !== LaesaProjects72929PMView ? transformProxies(this.props.children) : {
...
export default LaesaProjects72929PMView
