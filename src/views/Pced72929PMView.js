...
class Pced72929PMView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/Pced72929PMController')
  ...
  render() {
    const proxies = Controller !== Pced72929PMView ? transformProxies(this.props.children) : {
...
export default Pced72929PMView
