...
class Members72929PMView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/Members72929PMController')
  ...
  render() {
    const proxies = Controller !== Members72929PMView ? transformProxies(this.props.children) : {
...
export default Members72929PMView
