...
class MakeAccount72929PMView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/MakeAccount72929PMController')
      ...
      if (e.code == 'MODULE_NOT_FOUND') {
        Controller = MakeAccount72929PMView
  ...
  render() {
    const proxies = Controller !== MakeAccount72929PMView ? transformProxies(this.props.children) : {
...
export default MakeAccount72929PMView
