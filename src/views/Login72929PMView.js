...
class Login72929PMView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/Login72929PMController')
  ...
  render() {
    const proxies = Controller !== Login72929PMView ? transformProxies(this.props.children) : {
...
export default Login72929PMView
