...
class 40172929PMView extends React.Component {
  static get Controller() {
    if (Controller) return Controller

    try {
      Controller = require('../controllers/40172929PMController')
  ...
  render() {
    const proxies = Controller !== 40172929PMView ? transformProxies(this.props.children) : {
